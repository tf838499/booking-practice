...
const migrationSourcePath = "file:../../../../repo/migrations"
...
func initRepository(t *testing.T, db *sqlx.DB, files ...string) (repo pgDB) {
	...
	// "/home/kenhuang/workspace/ticket-booking/testdata/seats.yml"
	err = loader.Load()
	require.NoError(t, err)
